...
export default function About() {
	...
	return (
		<section className="px-sm md:px-[6rem] py-[2rem] lg:px-lg h-[calc(100vh-4.4375rem)] md:h-[calc(100vh-4.9375rem)] min-h-[35.625rem] md:min-h-[30rem] flex flex-col-reverse md:flex-row justify-center md:justify-around items-center gap-4 md:gap-10 lg:gap-24">
